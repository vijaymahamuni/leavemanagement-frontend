  ...
  return (
    <div className='ViewTop'>
      <div className="printable">
        ...
        <div className="userview_head" >
          <h4 style={{marginLeft:"40px",color:"white"}}>User Details</h4></div>
          <ArrowBackIcon className="record_backicon" onClick={goback_prevtab}></ArrowBackIcon>
