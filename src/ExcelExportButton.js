  ...
  const handleExport = async () => {
    const DownloadExcel = async (ExportArray) => {
      ...
      const headerStyle = {
        ...
        fill: {
          type: 'solid',
          color: 'a6c1ed' // Light blue background color for headers
        },
      };
      ...
      const cellStyle = {
        // Add any desired cell styles here
      };
      ...
      const headingStyle = {
        ...
        fill: {
          type: 'solid',
          color: '41e8b0' // Background color for the main heading
        },
        horizontalAlignment: 'center'
      };

      worksheet.cell(1, 1).value(Heading).style(headingStyle);
